...
#
# Generated by export_simulation on Sat May 17 15:06:56 +0100 2025
#
################################################################################
...
'-reset_run' switch to the './matlab_fir_0.sh' script.

./matlab_fir_0.sh -reset_run
...
./matlab_fir_0.sh -noclean_files

For more information on the script, please type './matlab_fir_0.sh -help'.
