...
HD_PWD='C:/Users/dell/Desktop/PFA_PROJET_FINAL/affichage-fir/affichage-fir.runs/matlab_fir_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matlab_fir_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matlab_fir_0.tcl
