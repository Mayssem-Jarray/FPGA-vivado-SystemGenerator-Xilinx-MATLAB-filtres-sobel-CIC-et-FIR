...
HD_PWD='C:/Users/dell/Desktop/PFA_PROJET_FINAL/project_FIR-final/project_FIR-final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aa.tcl -notrace
