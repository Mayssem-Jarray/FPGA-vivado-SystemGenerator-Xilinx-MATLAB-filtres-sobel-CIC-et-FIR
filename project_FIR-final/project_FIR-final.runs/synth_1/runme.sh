...
HD_PWD='C:/Users/dell/Desktop/PFA_PROJET_FINAL/project_FIR-final/project_FIR-final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aa.tcl
