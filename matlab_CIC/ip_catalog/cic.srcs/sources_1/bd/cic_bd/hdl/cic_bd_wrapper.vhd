...
--Command     : generate_target cic_bd_wrapper.bd
--Design      : cic_bd_wrapper
...
architecture STRUCTURE of cic_bd_wrapper is
  component cic_bd is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
  ...
  end component cic_bd;
begin
cic_bd_i: component cic_bd
     port map (
